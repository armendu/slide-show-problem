...
namespace SlideShowProblem
{
    public class GLS
    {
        ...
        private Solution Tweak(GLS instance, Solution s)
        {
            ...
            int currentInterestFactor = interestFactor - instance.DeltaFactor(slides, position1, position2);
            ...
            currentInterestFactor = currentInterestFactor + instance.DeltaFactor(slides, position1, position2);
